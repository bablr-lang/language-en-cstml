 ...
 * @generatedfrom ./grammar.macro.js#e250a303de7e3cea995375170d81d15f8c7996a4
...
let _initProto, _DoctypeTagDecs, _ReferenceDecs, _GapDecs, _ShiftDecs, _NullDecs, _NodeDecs, _PropertyDecs, _OpenNodeTagDecs, _CloseNodeTagDecs, _BooleanAttributeDecs, _MappingAttributeDecs, _IdentifierPathDecs, _StringDecs, _EscapeSequenceDecs, _LiteralDecs, _NumberDecs, _IntegerDecs, _BooleanDecs, _InfinityDecs, _PunctuatorDecs, _KeywordDecs, _AnyDecs;
...
export const grammar = class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Document"], [_DoctypeTagDecs, 2, "DoctypeTag"], [_ReferenceDecs, 2, "Reference"], [_GapDecs, 2, "Gap"], [_ShiftDecs, 2, "Shift"], [_NullDecs, 2, "Null"], [_NodeDecs, 2, "Node"], [_PropertyDecs, 2, "Property"], [[Node, AllowEmpty], 2, "Flags"], [_OpenNodeTagDecs, 2, "OpenNodeTag"], [_CloseNodeTagDecs, 2, "CloseNodeTag"], [_BooleanAttributeDecs, 2, "BooleanAttribute"], [_MappingAttributeDecs, 2, "MappingAttribute"], [_IdentifierPathDecs, 2, "IdentifierPath"], [_StringDecs, 2, "String"], [[AllowEmpty, Node], 2, "StringContent"], [_EscapeSequenceDecs, 2, "EscapeSequence"], [Node, 2, "EscapeCode"], [Node, 2, "Identifier"], [_LiteralDecs, 2, "Literal"], [_NumberDecs, 2, "Number"], [Node, 2, "UnsignedInteger"], [_IntegerDecs, 2, "Integer"], [_BooleanDecs, 2, "Boolean"], [Node, 2, "Digit"], [_InfinityDecs, 2, "Infinity"], [_PunctuatorDecs, 2, "Punctuator"], [_KeywordDecs, 2, "Keyword"], [_AnyDecs, 2, "Any"]], []).e;
  }
  constructor() {
    _initProto(this);
  }
  *[(_DoctypeTagDecs = [CoveredBy('Token'), CoveredBy('Expression'), Node], _ReferenceDecs = [Node, CoveredBy('Token'), CoveredBy('Expression')], _GapDecs = [Node, CoveredBy('Token'), CoveredBy('Expression'), CoveredBy('PropertyValue')], _ShiftDecs = [Node, CoveredBy('Token'), CoveredBy('Expression')], _NullDecs = [Node, CoveredBy('Token'), CoveredBy('Expression'), CoveredBy('PropertyValue')], _NodeDecs = [Node, CoveredBy('PropertyValue')], _PropertyDecs = [Node, CoveredBy('NodeChild')], _OpenNodeTagDecs = [Node, CoveredBy('Token')], _CloseNodeTagDecs = [Node, CoveredBy('Token')], _BooleanAttributeDecs = [Attributes(['true']), Node, CoveredBy('Attribute')], _MappingAttributeDecs = [Node, CoveredBy('Attribute')], _IdentifierPathDecs = [CoveredBy('Language'), Node], _StringDecs = [CoveredBy('AttributeValue'), CoveredBy('Language'), Node], _EscapeSequenceDecs = [Attributes(['cooked']), Node], _LiteralDecs = [Node, CoveredBy('Expression'), CoveredBy('NodeChild')], _NumberDecs = CoveredBy('AttributeValue'), _IntegerDecs = [CoveredBy('Number'), Node], _BooleanDecs = [CoveredBy('AattributeValue'), Node], _InfinityDecs = [CoveredBy('Number'), Node], _PunctuatorDecs = [Node, InjectFrom(productions)], _KeywordDecs = [Node, InjectFrom(productions)], _AnyDecs = InjectFrom(productions), Symbol.for('@bablr/fragment'))]() {
      ...
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`openToken`, _t.ref`values[]`, _t.ref`closeToken`], {
        ...
        values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`openToken`, _t.ref`flags`, _t.ref`type`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), _t.ref`intrinsicValue`, _t.ref`closeToken`], {
          ...
          intrinsicValue: _t.node(_l.Regex, "Pattern", [_t.ref`openToken`, _t.ref`alternatives[]`, _t.ref`closeToken`], {
            openToken: _t.s_i_node(_l.Regex, "Punctuator", "/"),
            alternatives: [_t.node(_l.Regex, "Alternative", [_t.ref`elements[]`], {
              elements: [_t.node(_l.Regex, "CharacterClass", [_t.ref`openToken`, _t.ref`elements[]`, _t.ref`elements[]`, _t.ref`elements[]`, _t.ref`elements[]`, _t.ref`elements[]`, _t.ref`closeToken`], {
                openToken: _t.s_i_node(_l.Regex, "Punctuator", "["),
                elements: [_t.node(_l.Regex, "CharacterClassRange", [_t.ref`min`, _t.ref`rangeToken`, _t.ref`max`], {
                  min: _t.node(_l.Regex, "Character", [_t.lit("a")], {}, {}),
                  rangeToken: _t.s_i_node(_l.Regex, "Punctuator", "-"),
