 ...
 * @generatedfrom ./grammar.macro.js#30048138ccb0a2deb8543dc312343cb6c5908607
...
export const grammar = class CSTMLGrammar {
  ...
  *[(_ArrayDecs = [CoveredBy('JSONExpression'), Node], _ObjectDecs = [CoveredBy('JSONExpression'), Node], _TupleDecs = [CoveredBy('JSONExpression'), Node], _DoctypeTagDecs = [CoveredBy('Tag'), CoveredBy('Expression'), Node], _ReferenceTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression')], _GapTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('PropertyValue')], _ShiftTagDecs = [Node, CoveredBy('Tag')], _NullTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('PropertyValue')], _ArrayTagDecs = [Node, CoveredBy('Tag'), CoveredBy('PropertyValue')], _NodeDecs = [Node, CoveredBy('PropertyValue')], _PropertyDecs = [Node, CoveredBy('NodeChild'), CoveredBy('FragmentChild')], _OpenNodeTagDecs = [UnboundAttributes(['balanced', 'balancedSpan']), Node, CoveredBy('Tag'), CoveredBy('OpenTag')], _OpenFragmentTagDecs = [Attributes({
    ...
    balancer: true
  }), Node, CoveredBy('Tag'), CoveredBy('CloseTag')], _BooleanAttributeDecs = [UnboundAttributes(['true']), Node, CoveredBy('Attribute')], _MappingAttributeDecs = [Node, CoveredBy('Attribute')], _IdentifierPathDecs = [CoveredBy('Language'), Node], _StringDecs = [CoveredBy('JSONExpression'), CoveredBy('Language'), Node], _LiteralTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('NodeChild'), CoveredBy('FragmentChild')], _NumberDecs = CoveredBy('JSONExpression'), _IntegerDecs = [CoveredBy('Number'), Node], _NullDecs = [CoveredBy('JSONExpression'), Node], _BooleanDecs = [CoveredBy('JSONExpression'), Node], _SeparatorDecs = [CoveredBy('JSONExpression'), Node], _InfinityDecs = [CoveredBy('Number'), Node], _PunctuatorDecs = [Node, InjectFrom(productions)], _KeywordDecs = [Node, InjectFrom(productions)], _AnyDecs = InjectFrom(productions), Symbol.for('@bablr/fragment'))]() {
