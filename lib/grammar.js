 ...
 * @generatedfrom ./grammar.macro.js#75edf35d2969cbdecebbc94a264163b0139b3b41
...
export const grammar = class CSTMLGrammar {
  ...
  *Tag() {
    yield eat(m`<Any />`, [m`<NullTag 'null' />`, m`<InitializerTag '[]' />`, m`<ReferenceTag /[.#@]|[a-zA-Z]/ />`, m`<LiteralTag /['"]/ />`, m`<DoctypeTag '<!' />`, m`<GapTag '<//>' />`, m`<ShiftTag '^^^' />`, m`<CloseNodeTag '</' />`, m`<OpenNodeTag '<' />`]);
  }
  *Document() {
