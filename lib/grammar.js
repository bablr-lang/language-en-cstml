...
export const grammar = class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(
      ...
      [
        ...
        [[AllowEmpty, Node], 2, 'ReferenceFlags'],
        [_BindingTagDecs, 2, 'BindingTag'],
        [_GapTagDecs, 2, 'GapTag'],
        [_ShiftTagDecs, 2, 'ShiftTag'],
        [_NullTagDecs, 2, 'NullTag'],
        [_InitializerTagDecs, 2, 'InitializerTag'],
        [_AttributeDefinitionDecs, 2, 'AttributeDefinition'],
        [_NodeDecs, 2, 'Node'],
        [_PropertyDecs, 2, 'Property'],
        [[Node, AllowEmpty], 2, 'NodeFlags'],
        [_OpenNodeTagDecs, 2, 'OpenNodeTag'],
        [_CloseNodeTagDecs, 2, 'CloseNodeTag'],
        [Node, 2, 'IdentifierPath'],
        [Node, 2, 'Identifier'],
        [Node, 2, 'IdentifierContent'],
  ...
  *[((_DoctypeTagDecs = [CoveredBy('Tag'), CoveredBy('Expression'), Node]),
  ...
  (_BindingTagDecs = [Node, CoveredBy('Tag')]),
  ...
  (_AttributeDefinitionDecs = [Node, CoveredBy('Tag')]),
  (_NodeDecs = [Node, CoveredBy('PropertyValue')]),
  (_PropertyDecs = [Node, CoveredBy('NodeChild')]),
  (_OpenNodeTagDecs = [UndefinedAttributes(['balanced', 'balancedSpan']), Node, CoveredBy('Tag')]),
  (_CloseNodeTagDecs = [
    Attributes({
      balancer: true,
    }),
  ...
  (_LiteralTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('NodeChild')]),
  (_PunctuatorDecs = [Literal, Node, InjectFrom(productions)]),
  (_KeywordDecs = [Literal, Node, InjectFrom(productions)]),
  ...
  *NodeFlags() {
    ...
    yield eatMatch(
      m`multiFragmentToken: <*Punctuator '_' />`,
      o({}),
      o({
        bind: true,
      }),
  ...
  *Identifier() {
    ...
    yield eat(
      m`content: <*IdentifierContent { span: 'Identifier' } />`,
      o({
        quoted: !!q,
      }),
    );
