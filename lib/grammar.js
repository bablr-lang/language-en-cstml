 ...
 * @generatedfrom ./grammar.macro.js#d4243090e0e1a1be40cf4a6d72bf619541493b79
...
export const grammar = class CSTMLGrammar {
  ...
  *Tag() {
    yield eat(m`<_Any />`, [m`<NullTag 'null' />`, m`<InitializerTag '[]' />`, m`<ReferenceTag /[.#@a-zA-Z\u0060\u{80}-\u{10ffff}]/ />`, m`<LiteralTag /['"]/ />`, m`<DoctypeTag '<!' />`, m`<GapTag '<//>' />`, m`<ShiftTag '^^^' />`, m`<CloseNodeTag '</' />`, m`<OpenNodeTag '<' />`]);
  }
  *Document() {
  ...
  *PropertyValue() {
    yield eat(m`<_Any />`, [m`<NullTag 'null' />`, m`<GapTag '<//>' />`, m`<InitializerTag '[]' />`, m`<Node /\<[^#@]/ />`]);
  }
  *NodeFlags() {
