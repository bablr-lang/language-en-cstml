 ...
 * @generatedfrom ./grammar.macro.js#ccbe3615dbd41b667acd816e218a43fe5626ccc5
...
export const grammar = class CSTMLGrammar {
  ...
  *Expression() {
    yield eat(m`<Any />`, e([m`<NullTag 'null' />`, m`<ReferenceTag /\.|[a-zA-Z]/ />`, m`<LiteralTag /['"]/ />`, m`<DoctypeTag '<!' />`, m`<GapTag '<//>' />`, m`<Node '<' />`]));
  }
  *Tag() {
  ...
  *NodeChild({
    ...
    if (token && ctx.unbox(token)) {
      ...
      yield eat(m`<Any />`, e([m`<Node /\<\*?#/ />`, m`<Property /\.|[a-zA-Z]/ />`, m`<ShiftTag '^^^' />`]));
    }
  }
  *FragmentChild({
    value: props,
  ...
  *AttributeValue() {
    yield eat(m`<Any />`, e([m`<String /['"]/ />`, m`<Number /[\d+-]/ />`, m`<Boolean /true|false/ />`]));
  }
  *TagType() {
