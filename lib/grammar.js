 ...
 * @generatedfrom ./grammar.macro.js#7ab24a6ee0feb5568d02b986a0303b71f7c217cd
...
import {
  ...
  interpolateFragmentChildren as _interpolateFragmentChildren,
...
let _initProto,
  ...
  _CloseNodeTagDecs,
  _CloseFragmentTagDecs,
  _BooleanAttributeDecs,
  _MappingAttributeDecs,
  _IdentifierPathDecs,
  _StringDecs,
  _LiteralTagDecs,
  _NumberDecs,
    ...
    yield _t.node(
      ...
      [_t.ref`verb`, _t.ref`arguments`],
      {
        ...
        arguments: _t.node(
          _l.Instruction,
          'Tuple',
          [_t.ref`openToken`, _t.ref`values[]`, _t.arr(), _t.ref`values[]`, _t.ref`closeToken`],
          {
                ...
                ],
                {
                  ...
                  alternatives: [
                    _t.node(
                      _l.Regex,
                      'Alternative',
                      [_t.ref`elements[]`, _t.arr(), _t.ref`elements[]`],
                      {
                        elements: [
                          _t.node(
                            _l.Regex,
                ...
                [_t.ref`open`],
                {
                  open: _t.node(
                    ...
                    [
                      ...
                      _t.ref`type`,
                      _t.embedded(_t.node(_l.Spamex, 'Space', [_t.lit(' ')], {}, {})),
                      _t.ref`selfClosingTagToken`,
                      _t.ref`closeToken`,
                    ],
                    {
                      ...
                      language: _t.node(
                        _l.CSTML,
                        'IdentifierPath',
                        [_t.ref`segments[]`, _t.arr(), _t.ref`segments[]`],
                        {
...
export const grammar = class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(
      ...
      [
        ...
        [Node, 2, 'ObjectProperty'],
        [_TupleDecs, 2, 'Tuple'],
        [_DoctypeTagDecs, 2, 'DoctypeTag'],
        [_ReferenceTagDecs, 2, 'ReferenceTag'],
        [_GapTagDecs, 2, 'GapTag'],
        [_ShiftTagDecs, 2, 'ShiftTag'],
        [_NullTagDecs, 2, 'NullTag'],
        [_ArrayTagDecs, 2, 'ArrayTag'],
        [_NodeDecs, 2, 'Node'],
        [Node, 2, 'Fragment'],
        [_PropertyDecs, 2, 'Property'],
        [[Node, AllowEmpty], 2, 'Flags'],
        [_OpenNodeTagDecs, 2, 'OpenNodeTag'],
        [_OpenFragmentTagDecs, 2, 'OpenFragmentTag'],
        [AllowEmpty, 2, 'Attributes'],
        [_CloseNodeTagDecs, 2, 'CloseNodeTag'],
        [_CloseFragmentTagDecs, 2, 'CloseFragmentTag'],
        [_BooleanAttributeDecs, 2, 'BooleanAttribute'],
        [_MappingAttributeDecs, 2, 'MappingAttribute'],
        [AllowEmpty, 2, 'TagType'],
        [_IdentifierPathDecs, 2, 'IdentifierPath'],
        [_StringDecs, 2, 'String'],
        [[AllowEmpty, Node], 2, 'StringContent'],
        [Node, 2, 'EscapeSequence'],
        [Node, 2, 'EscapeCode'],
        [Node, 2, 'Identifier'],
        [_LiteralTagDecs, 2, 'LiteralTag'],
        [_NumberDecs, 2, 'Number'],
        [Node, 2, 'UnsignedInteger'],
        [_IntegerDecs, 2, 'Integer'],
        [_NullDecs, 2, 'Null'],
        [_BooleanDecs, 2, 'Boolean'],
        [_SeparatorDecs, 2, 'Separator'],
  ...
  *[((_ArrayDecs = [CoveredBy('JSONExpression'), Node]),
  (_ObjectDecs = [CoveredBy('JSONExpression'), Node]),
  (_TupleDecs = [CoveredBy('JSONExpression'), Node]),
  (_DoctypeTagDecs = [CoveredBy('Tag'), CoveredBy('Expression'), Node]),
  (_ReferenceTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression')]),
  (_GapTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('PropertyValue')]),
  (_ShiftTagDecs = [Node, CoveredBy('Tag')]),
  (_NullTagDecs = [Node, CoveredBy('Tag'), CoveredBy('Expression'), CoveredBy('PropertyValue')]),
  (_ArrayTagDecs = [Node, CoveredBy('Tag'), CoveredBy('PropertyValue')]),
  (_NodeDecs = [Node, CoveredBy('PropertyValue')]),
  (_PropertyDecs = [Node, CoveredBy('NodeChild'), CoveredBy('FragmentChild')]),
  (_OpenNodeTagDecs = [
  ...
  (_BooleanAttributeDecs = [UnboundAttributes(['true']), Node, CoveredBy('Attribute')]),
  (_MappingAttributeDecs = [Node, CoveredBy('Attribute')]),
  (_IdentifierPathDecs = [CoveredBy('Language'), Node]),
  (_StringDecs = [CoveredBy('JSONExpression'), CoveredBy('Language'), Node]),
  (_LiteralTagDecs = [
    Node,
    CoveredBy('Tag'),
  ...
  (_NumberDecs = CoveredBy('JSONExpression')),
  (_IntegerDecs = [CoveredBy('Number'), Node]),
  (_NullDecs = [CoveredBy('JSONExpression'), Node]),
  (_BooleanDecs = [CoveredBy('JSONExpression'), Node]),
  (_SeparatorDecs = [CoveredBy('JSONExpression'), Node]),
      ...
      [_t.ref`verb`, _t.ref`arguments`],
      {
        ...
        arguments: _t.node(
          ...
          [
            9,
            [
              [_t.ref`openToken`, _t.ref`values[]`, _t.arr(), _t.ref`values[]`],
              [
                _t.ref`separators[]`,
                _t.arr(),
                _t.ref`separators[]`,
          ...
          ],
          {
            ...
            separators: [
              _t.node(
                _l.Instruction,
                'Separator',
                [_t.embedded(_t.node(_l.Instruction, 'Space', [_t.lit(' ')], {}, {}))],
                {},
                {},
              ),
            ],
                      ...
                      [
                        ...
                        [
                          [
                            _t.ref`openToken`,
                            _t.embedded(
                              _t.node(_l.Instruction, 'Space', [_t.lit('\n      ')], {}, {}),
                            ),
                            _t.ref`elements[]`,
                            _t.arr(),
                          ],
              ...
              _t.node(
                ...
                [
                  ...
                  [
                    ...
                    [_t.ref`elements[]`, _t.ref`separators[]`, _t.arr(), _t.ref`separators[]`],
                    [
                      _t.ref`elements[]`,
                      _t.ref`separators[]`,
                      _t.ref`elements[]`,
                ...
                _t.node(
                  ...
                  ],
                  {
                    ...
                    flags: _t.node(
                      _l.Regex,
                      'Flags',
                      [_t.ref`tokens[]`, _t.arr(), _t.ref`tokens[]`],
                      {
                    ...
                    ],
                    {
                      ...
                      alternatives: [
                        _t.node(
                          _l.Regex,
                          'Alternative',
                          [_t.ref`elements[]`, _t.arr(), _t.ref`elements[]`, _t.ref`elements[]`],
                          {
                            elements: [
                              _t.node(
                                _l.Regex,
          ...
          ],
          {
            ...
            values: [
              _t.node(
                _l.Instruction,
                'Array',
                [_t.ref`openToken`, _t.ref`closeToken`],
                {
                  openToken: _t.s_node(_l.Instruction, 'Punctuator', '['),
                  closeToken: _t.s_node(_l.Instruction, 'Punctuator', ']'),
                },
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.arr(),
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(buildBoolean(balanced), _t.ref`values[]`),
                _t.ref`closeToken`,
              ],
            ],
          ],
              ...
              values: [
                _t.node(
                  ...
                  [
                    9,
                    [
                      [_t.ref`openToken`, _t.ref`alternatives[]`, _t.arr(), _t.ref`alternatives[]`],
                      [
                        _t.ref`separators[]`,
                        _t.arr(),
                        _t.ref`separators[]`,
                ...
                _t.node(
                  ...
                  [_t.ref`openToken`, _t.ref`content`, _t.ref`closeToken`],
                  {
                    ...
                    content: _t.node(
                      _l.CSTML,
                      'Content',
                      [_t.lit('namespaceSeparatorToken')],
                      {},
                      {},
                    ),
                    closeToken: _t.s_node(_l.CSTML, 'Punctuator', "'"),
                                  ...
                                  _t.node(
                                    ...
                                    ],
                                    {
                                      ...
                                      elements: [
                                        ...
                                        _t.node(_l.Regex, 'Character', [_t.lit('r')], {}, {}),
                                        _t.node(_l.Regex, 'Character', [_t.lit('t')], {}, {}),
                                        _t.node(_l.Regex, 'Character', [_t.lit('0')], {}, {}),
                                        _t.node(_l.Regex, 'Character', [_t.lit("'")], {}, {}),
                                      ],
                                      closeToken: _t.s_node(_l.Regex, 'Punctuator', ']'),
                                    },
                              ...
                              element: _t.node(
                                ...
                                ],
                                {
                                  ...
                                  elements: [
                                    ...
                                    _t.node(_l.Regex, 'Character', [_t.lit('_')], {}, {}),
                                    _t.node(_l.Regex, 'Character', [_t.lit('-')], {}, {}),
                                  ],
                                  closeToken: _t.s_node(_l.Regex, 'Punctuator', ']'),
                                },
