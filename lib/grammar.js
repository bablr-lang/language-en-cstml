 ...
 * @generatedfrom ./grammar.macro.js#b143710124ca3a4065654f56b3dcfce5f9426223
 * This file is autogenerated. Please do not edit it directly.
 * When editing run `npx macrome watch` then change the file this is generated from.
 */
import _applyDecs from "@babel/runtime/helpers/applyDecs2305";
let _initProto, _DoctypeTagDecs, _ReferenceTagDecs, _GapTagDecs, _ShiftTagDecs, _NullTagDecs, _InitializerTagDecs, _AttributeDefinitionDecs, _NodeDecs, _PropertyDecs, _OpenNodeTagDecs, _CloseNodeTagDecs, _IdentifierPathDecs, _LiteralTagDecs, _PunctuatorDecs, _KeywordDecs, _AnyDecs;
...
export const grammar = class CSTMLGrammar {
  ...
  *Tag() {
    yield eat(m`<_Any />`, [m`<NullTag 'null' />`, m`<InitializerTag /\[\]|undefined/ />`, m`<AttributeDefinition '{' />`, m`<ReferenceTag /[.#@a-zA-Z\u0060\u{80}-\u{10ffff}]/ />`, m`<LiteralTag /['"]/ />`, m`<DoctypeTag '<!' />`, m`<GapTag '<//>' />`, m`<ShiftTag '^^^' />`, m`<CloseNodeTag '</' />`, m`<OpenNodeTag '<' />`]);
  }
  *Document() {
  ...
  *NodeChild({
    ...
    if (token) {
      ...
      yield eat(m`<_Any />`, [m`<Property /[.#\\a-zA-Z\u0060\u{80}-\u{10ffff}]/ />`, m`<AttributeDefinition '{' />`, m`<ShiftTag '^^^' />`]);
    }
  }
  *Property() {
