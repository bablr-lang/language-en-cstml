...
export const grammar = (_dec = ImplementedBy(productions), _dec2 = ImplementedBy(productions), _dec3 = ImplementedBy(productions), _dec4 = CoveredBy('Tag'), _dec5 = CoveredBy('Tag'), _dec6 = CoveredBy('Tag'), _dec7 = CoveredBy('Tag'), _dec8 = CoveredBy('Tag'), _dec9 = CoveredBy('Tag'), _dec10 = CoveredBy('Tag'), _dec11 = CoveredBy('Tag'), _dec12 = CoveredBy('Attribute'), _dec13 = CoveredBy('Attribute'), class CSTMLGrammar {
  static {
