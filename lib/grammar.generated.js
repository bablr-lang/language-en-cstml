...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _initProto;
...
export const grammar = triviaEnhancer({
...
}, (_dec = CoveredBy('Tree'), _dec2 = CoveredBy('Token'), _dec3 = CoveredBy('Token'), _dec4 = CoveredBy('PropertyValue'), _dec5 = CoveredBy('PropertyValue'), _dec6 = CoveredBy('Tree'), _dec7 = CoveredBy('NodeChild'), _dec8 = CoveredBy('Token'), _dec9 = CoveredBy('Token'), _dec10 = CoveredBy('Token'), _dec11 = CoveredBy('Token'), _dec12 = CoveredBy('Attribute'), _dec13 = CoveredBy('Attribute'), _dec14 = CoveredBy('Token'), _dec15 = CoveredBy('NodeChild'), _dec16 = InjectFrom(productions), _dec17 = InjectFrom(productions), _dec18 = InjectFrom(productions), class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(this, [[[Node, _dec], 2, "Fragment"], [[Node, _dec2], 2, "Reference"], [[Node, _dec3, _dec4], 2, "Gap"], [[Node, _dec5, _dec6], 2, "Node"], [[Node, _dec7], 2, "Property"], [[Node, _dec8], 2, "OpenFragmentTag"], [Node, 2, "FragmentFlags"], [[Node, _dec9], 2, "OpenNodeTag"], [Node, 2, "NodeFlags"], [[Node, _dec10], 2, "CloseNodeTag"], [[Node, _dec11], 2, "CloseFragmentTag"], [[Node, _dec12], 2, "BooleanAttribute"], [[Node, _dec13], 2, "MappingAttribute"], [Node, 2, "String"], [Node, 2, "StringContent"], [Node, 2, "EscapeSequence"], [Node, 2, "EscapeCode"], [Node, 2, "Identifier"], [[Node, _dec14, _dec15], 2, "Literal"], [Node, 2, "Integer"], [Node, 2, "Digit"], [Node, 2, "Infinity"], [[Node, _dec16], 2, "Punctuator"], [[Node, _dec17], 2, "Keyword"], [_dec18, 2, "Match"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
  ...
  *EscapeSequence(props, s, ctx) {
    ...
    let code = ctx.getSourceText(yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      verb: _t.node(_l.Instruction, "Identifier", [_t.lit("eat")], {}, {}),
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, 'Space', [{
        type: "Literal",
        value: " "
    ...
    yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      ...
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, 'Space', [{
        type: "Literal",
        value: " "
      }], {}, [])), ..._interpolateArrayChildren(buildString(escapables.get(code)), _t.ref`values[]`, _t.embedded(_t.t_node(_l.Comment, null, [_t.embedded(_t.t_node('Space', 'Space', [_t.lit(' ')]))]))), _t.ref`close`], {
        open: _t.s_node(_l.Instruction, "Punctuator", "("),
        values: [_t.node(_l.Instruction, "Identifier", [_t.lit("cooked")], {}, {}), ..._interpolateArray(buildString(escapables.get(code)))],
        close: _t.s_node(_l.Instruction, "Punctuator", ")")
      }, {})
    }, {});
  }
  *EscapeCode(props, {
    ...
    span === 'String:Single' ? yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      verb: _t.node(_l.Instruction, "Identifier", [_t.lit("eat")], {}, {}),
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.ref`close`], {
        open: _t.s_node(_l.Instruction, "Punctuator", "("),
        values: [_t.node(_l.Regex, "Pattern", [_t.ref`open`, _t.ref`alternatives[]`, _t.ref`close`], {
