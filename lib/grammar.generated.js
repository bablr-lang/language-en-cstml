...
}, (_dec = CoveredBy('PropertyValue'), _dec2 = CoveredBy('FragmentChild'), _dec3 = CoveredBy('NodeChild'), _dec4 = CoveredBy('Attribute'), _dec5 = CoveredBy('Attribute'), _dec6 = CoveredBy('TagType'), _dec7 = CoveredBy('TagType'), _dec8 = CoveredBy('NodeChild'), _dec9 = CoveredBy('Terminal'), _dec10 = CoveredBy('Terminal'), _dec11 = CoveredBy('FragmentChild'), _dec12 = CoveredBy('NodeChild'), _dec13 = CoveredBy('Terminal'), _dec14 = CoveredBy('PropertyValue'), _dec15 = InjectFrom(productions), _dec16 = InjectFrom(productions), _dec17 = InjectFrom(productions), class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Fragment"], [[Node, _dec], 2, "Node"], [Node, 2, "Reference"], [[Node, _dec2, _dec3], 2, "Property"], [Node, 2, "OpenFragmentTag"], [Node, 2, "FragmentFlags"], [Node, 2, "OpenNodeTag"], [Node, 2, "NodeFlags"], [Node, 2, "CloseNodeTag"], [Node, 2, "CloseFragmentTag"], [[Node, _dec4], 2, "BooleanAttribute"], [[Node, _dec5], 2, "MappingAttribute"], [[Node, _dec6], 2, "GlobalIdentifier"], [[Node, _dec7], 2, "Identifier"], [_dec8, 2, "Terminal"], [[Node, _dec9], 2, "Escape"], [[Node, _dec10, _dec11, _dec12], 2, "Trivia"], [[Node, _dec13], 2, "Literal"], [Node, 2, "Integer"], [Node, 2, "Digit"], [Node, 2, "Infinity"], [[Node, _dec14], 2, "Null"], [[Node, _dec15], 2, "Punctuator"], [[Node, _dec16], 2, "Keyword"], [_dec17, 2, "Match"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
