...
export const grammar = (_computedKey = Symbol.for('@bablr/fragment'), _dec = CoveredBy('Expression'), _dec2 = CoveredBy('Tree'), _dec3 = CoveredBy('Expression'), _dec4 = CoveredBy('Expression'), _dec5 = CoveredBy('PropertyValue'), _dec6 = CoveredBy('Expression'), _dec7 = CoveredBy('PropertyValue'), _dec8 = CoveredBy('PropertyValue'), _dec9 = CoveredBy('Tree'), _dec10 = CoveredBy('NodeChild'), _dec11 = CoveredBy('Expression'), _dec12 = CoveredBy('Expression'), _dec13 = CoveredBy('Expression'), _dec14 = CoveredBy('Expression'), _dec15 = Attributes(['true']), _dec16 = CoveredBy('Attribute'), _dec17 = CoveredBy('Attribute'), _dec18 = CoveredBy('Language'), _dec19 = CoveredBy('Language'), _dec20 = Attributes(['cooked']), _dec21 = CoveredBy('Expression'), _dec22 = CoveredBy('NodeChild'), _dec23 = InjectFrom(productions), _dec24 = InjectFrom(productions), _dec25 = InjectFrom(productions), class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Document"], [[_dec, Node], 2, "DoctypeTag"], [[Node, _dec2], 2, "Fragment"], [[Node, _dec3], 2, "Reference"], [[Node, _dec4, _dec5], 2, "Gap"], [[Node, _dec6, _dec7], 2, "Null"], [[Node, _dec8, _dec9], 2, "Node"], [[Node, _dec10], 2, "Property"], [[Node, _dec11], 2, "OpenFragmentTag"], [[Node, _dec12], 2, "OpenNodeTag"], [Node, 2, "Flags"], [[Node, _dec13], 2, "CloseNodeTag"], [[Node, _dec14], 2, "CloseFragmentTag"], [[_dec15, Node, _dec16], 2, "BooleanAttribute"], [[Node, _dec17], 2, "MappingAttribute"], [[_dec18, Node], 2, "IdentifierPath"], [[_dec19, Node], 2, "String"], [[AllowEmpty, Node], 2, "StringContent"], [[_dec20, Node], 2, "EscapeSequence"], [Node, 2, "EscapeCode"], [Node, 2, "Identifier"], [[Node, _dec21, _dec22], 2, "Literal"], [Node, 2, "PositiveInteger"], [Node, 2, "Integer"], [Node, 2, "Digit"], [Node, 2, "Infinity"], [[Node, _dec23], 2, "Punctuator"], [[Node, _dec24], 2, "Keyword"], [_dec25, 2, "Match"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
    ...
    yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      ...
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.ref`close`], {
        ...
        values: [_t.node(_l.CSTML, "Gap", [_t.ref`value`], {
          value: _t.s_node(_l.CSTML, "Punctuator", "<//>")
        }, {})],
        close: _t.s_node(_l.Instruction, "Punctuator", ")")
      }, {})
    }, {});
  ...
  *DoctypeTag() {
    ...
    yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      ...
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), _t.ref`values[]`, _t.ref`close`], {
        ...
        values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`open`, _t.ref`type`, _t.ref`close`], {
          open: _t.s_node(_l.Spamex, "Punctuator", "<"),
          type: _t.s_node(_l.Spamex, "Identifier", "PositiveInteger"),
          close: _t.s_node(_l.Spamex, "Punctuator", ">")
        }, {}), _t.node(_l.CSTML, "String", [_t.ref`open`, _t.ref`content`, _t.ref`close`], {
          open: _t.s_node(_l.CSTML, "Punctuator", "'"),
    ...
    do {
      esc = (yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
        ...
        arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.ref`close`], {
          ...
          values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`open`, _t.ref`flags`, _t.ref`type`, _t.ref`close`], {
            open: _t.s_node(_l.Spamex, "Punctuator", "<"),
            flags: _t.node(_l.CSTML, "Flags", [_t.ref`escape`], {
      ...
      yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
        ...
        arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), _t.ref`values[]`, _t.ref`close`], {
          ...
          values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`open`, _t.ref`flags`, _t.ref`type`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), _t.ref`value`, _t.ref`close`], {
            ...
            type: _t.s_node(_l.Spamex, "Identifier", "Keyword"),
            value: buildString(match_.value),
            close: _t.s_node(_l.Spamex, "Punctuator", ">")
          }, {}), _t.node(_l.CSTML, "String", [_t.ref`open`, _t.ref`content`, _t.ref`close`], {
            open: _t.s_node(_l.CSTML, "Punctuator", "'"),
            content: _t.node(_l.CSTML, "Content", [_t.lit("value")], {}, {}),
  ...
  *Digits(props, s) {
    const path = s.path.startTag ? _t.node(_l.Instruction, "Null", [_t.ref`value`], {
      value: _t.s_node(_l.Instruction, "Keyword", "null")
    }, {}) : _t.node(_l.CSTML, "String", [_t.ref`open`, _t.ref`content`, _t.ref`close`], {
      open: _t.s_node(_l.CSTML, "Punctuator", "'"),
      content: _t.node(_l.CSTML, "Content", [_t.lit("digits[]")], {}, {}),
    ...
    while (yield _t.node(_l.Instruction, "Call", [_t.ref`verb`, _t.ref`arguments`], {
      verb: _t.s_node(_l.Instruction, "Identifier", "eatMatch"),
      arguments: _t.node(_l.Instruction, "Tuple", [_t.ref`open`, _t.ref`values[]`, _t.embedded(_t.s_t_node(_l.Space, "Space", [_t.lit(" ")], {}, {})), ..._interpolateArrayChildren(path, _t.ref`values[]`, _t.embedded(_t.t_node(_l.Comment, null, [_t.embedded(_t.t_node('Space', 'Space', [_t.lit(' ')]))]))), _t.ref`close`], {
        open: _t.s_node(_l.Instruction, "Punctuator", "("),
        values: [_t.node(_l.Spamex, "NodeMatcher", [_t.ref`open`, _t.ref`flags`, _t.ref`type`, _t.ref`close`], {
          open: _t.s_node(_l.Spamex, "Punctuator", "<"),
          flags: _t.node(_l.CSTML, "Flags", [_t.ref`token`], {
