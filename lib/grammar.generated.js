...
}, (_dec = CoveredBy('Tree'), _dec2 = CoveredBy('Token'), _dec3 = CoveredBy('Token'), _dec4 = CoveredBy('PropertyValue'), _dec5 = CoveredBy('Token'), _dec6 = CoveredBy('PropertyValue'), _dec7 = CoveredBy('PropertyValue'), _dec8 = CoveredBy('Tree'), _dec9 = CoveredBy('NodeChild'), _dec10 = CoveredBy('Token'), _dec11 = CoveredBy('Token'), _dec12 = CoveredBy('Token'), _dec13 = CoveredBy('Token'), _dec14 = CoveredBy('Attribute'), _dec15 = CoveredBy('Attribute'), _dec16 = CoveredBy('Token'), _dec17 = CoveredBy('NodeChild'), _dec18 = InjectFrom(productions), _dec19 = InjectFrom(productions), _dec20 = InjectFrom(productions), class CSTMLGrammar {
  static {
    [_initProto] = _applyDecs(this, [[[Node, _dec], 2, "Fragment"], [[Node, _dec2], 2, "Reference"], [[Node, _dec3, _dec4], 2, "Gap"], [[Node, _dec5, _dec6], 2, "Null"], [[Node, _dec7, _dec8], 2, "Node"], [[Node, _dec9], 2, "Property"], [[Node, _dec10], 2, "OpenFragmentTag"], [Node, 2, "FragmentFlags"], [[Node, _dec11], 2, "OpenNodeTag"], [Node, 2, "NodeFlags"], [[Node, _dec12], 2, "CloseNodeTag"], [[Node, _dec13], 2, "CloseFragmentTag"], [[Node, _dec14], 2, "BooleanAttribute"], [[Node, _dec15], 2, "MappingAttribute"], [Node, 2, "String"], [Node, 2, "StringContent"], [Node, 2, "EscapeSequence"], [Node, 2, "EscapeCode"], [Node, 2, "Identifier"], [[Node, _dec16, _dec17], 2, "Literal"], [Node, 2, "Integer"], [Node, 2, "Digit"], [Node, 2, "Infinity"], [[Node, _dec18], 2, "Punctuator"], [[Node, _dec19], 2, "Keyword"], [_dec20, 2, "Match"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
